...
Please keep in mind that the base directory of this project is found at ```https://github.com/jpnaranjo20/DjangoWebApp```. Each of the files that are described below have this base directory, but for the purposes of keeping a clean look on this document, I will only write the part of the directory that goes after the base one.
